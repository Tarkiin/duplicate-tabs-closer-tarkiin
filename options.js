...
const isPanelOptionOpen = () => {
    // Note: chrome.runtime.getViews() is not available in Manifest V3 service workers
    // This function now returns false as a safe fallback
    // If popup/tab state tracking is needed, implement using chrome.storage or messaging
    return false;
};
